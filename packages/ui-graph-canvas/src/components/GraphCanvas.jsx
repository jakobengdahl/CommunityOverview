...
/**
 * Build a URL from a template by substituting {field} and [field] placeholders
 * with values from nodeData. Only http:// and https:// URLs are allowed.
 * Substituted values are URI-component encoded to prevent injection.
 */
