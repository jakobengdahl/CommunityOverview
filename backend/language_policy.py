...
def get_language_policy(presentation: Dict[str, Any]) -> Dict[str, Any]:
    ...
    primary_language = policy.get("primary_language", presentation.get("default_language", "en"))
...
def format_language_policy_for_prompt(presentation: Dict[str, Any], *, external_agent: bool = False) -> str:
    ...
    description = policy["description_en"] or policy["description_sv"] or "No explicit language policy has been configured."
    user_language_line = (
