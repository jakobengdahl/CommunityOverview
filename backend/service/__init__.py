"""
backend.service - Service layer for Community Knowledge Graph
...
Architecture:
- GraphService: Business logic layer wrapping backend.core
...
- Stateless operations (state managed by backend.core)
- Thread-safe through backend.core
