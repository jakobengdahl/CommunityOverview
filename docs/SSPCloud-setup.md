...
<https://datalab.sspcloud.fr/launcher/ide/vscode-python?name=communityoverview-stat-metadata&version=2.5.6&s3=default&vault.secret=«communityoverview-secrets»&git.repository=«https%3A%2F%2Fgithub.com%2Fjakobengdahl%2FCommunityOverview%2F»&git.branch=«dev»&networking.user.enabled=true&networking.user.ports[0]=8000&autoLaunch=true>
...
3. Configure the following settings:
   ...
   - **Git** — set Repository to `https://github.com/jakobengdahl/CommunityOverview/` and Branch to `dev`.
