...
import './CreateSubscriptionDialog.css'; // reuse same dialog styles

export default function CreateSkillDialog({ onClose, onSave, initialData }) {
    ...
    <div className="dialog-overlay" onClick={onClose}>
      <div className="dialog-content subscription-dialog" onClick={e => e.stopPropagation()}>
        ...
        <p className="dialog-description">
          A Skill defines reusable instructions for an AI agent. Compatible with the SKILL.md format.
        </p>
          ...
          <div className="form-section">
            ...
            <div className="form-group">
              ...
              <input
                ...
                placeholder="E.g. 'Metadata quality check'"
                required
              />
            </div>
          ...
          <div className="form-section">
            ...
            <div className="form-group">
              ...
              <input
                ...
                placeholder="search_graph, web_fetch, add_nodes"
              />
            </div>
